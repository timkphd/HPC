...
!!! note
    The slurm output files generated by PLEXOS is a mix of encodings.  The simplest way to view the output is to convert it to UTF-8 using the iconv command.
