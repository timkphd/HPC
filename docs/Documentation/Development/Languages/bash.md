...
[NLR HPC Github](https://github.com/NatLabRockies/HPC/tree/master/general/bash) - User-contributed bash script and examples that you can use on HPC systems.

[BASH cheat sheet](https://github.com/NatLabRockies/HPC/blob/master/general/bash/cheatsheet.sh) - A concise and extensive list of example commands, built-ins, control structures, and other useful bash scripting material.
